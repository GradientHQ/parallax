...
|MiniMax-M2    | MiniMax AI  | [MiniMax-M2.5](https://huggingface.co/MiniMaxAI/MiniMax-M2.5)<br>[MiniMax-M2](https://huggingface.co/MiniMaxAI/MiniMax-M2)<br>[MiniMax-M2.1](https://huggingface.co/MiniMaxAI/MiniMax-M2.1) | [MiniMax M2.5: Top Open-Source Model](https://www.minimax.io/news/minimax-m25) | MiniMax-M2.5 is the latest sparse MoE model in the MiniMax-M2 family (456B parameters, 46B active) with a 1M token context window, excelling at coding, reasoning, and agentic workflows. |
