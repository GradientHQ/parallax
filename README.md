...
|MiniMax-M3    | MiniMax AI  | [MiniMax-M3](https://huggingface.co/MiniMaxAI/MiniMax-M3)<br>[MiniMax-M2.7](https://huggingface.co/MiniMaxAI/MiniMax-M2.7) | [MiniMax M2.1: Significantly Enhanced Multi-Language Programming](https://www.minimax.io/news/minimax-m21) | MiniMax-M3 is the latest sparse MoE model in the MiniMax series. MiniMax-M2.7 remains supported as the previous-generation model (about 230B parameters, 10B active) built for advanced coding and agentic workflows, delivering efficient, reliable tool use and strong multi-step reasoning. |
