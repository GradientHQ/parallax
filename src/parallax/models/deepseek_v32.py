        ...
        **kwargs,
        ...
        if target_len == 1:
            ...
            if target_len < self.index_topk:
                # Shape must be (batch, target_len, index_topk) to match the normal case
        ...
        **kwargs,
        ...
        if target_len == 1:
            ...
            if topk_indices is not None:
                ...
                # For batches where all topk_indices are -1, select all tokens (set sparse_mask to True)
                all_minus_one = (topk_indices == -1).all(
